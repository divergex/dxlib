...
class Executor:
    ...
    And uses the set Strategy object to generate output data.

    The executor then returns a History object with the output schema, given the output generated by the strategy.
    This can be used for training and testing models, and backtesting, paper trading and live trading strategies.
    """
